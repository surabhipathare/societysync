		...
		<div class="panel-body"><!--PANEL BODY DIV-->
			...
			<form name="event_form" action="" method="post" class="form-horizontal" enctype="multipart/form-data" id="event_form">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input id="notice_title" class="form-control text-input validate[required,custom[onlyLetter_specialcharacter]]" maxlength="50" type="text"  value="<?php if($edit){ echo esc_attr($result->event_title);}elseif(isset($_POST['notice_title'])) echo esc_attr($_POST['notice_title']);?>" name="notice_title">
					</div>
				</div>
				<!--END EVENT TITLE-->
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input id="start_time" placeholder="<?php esc_html_e('Select Start Time','apartment_mgt');?>" type="text" value="<?php if($edit){ echo  $result->start_time;}elseif(isset($_POST['start_time'])) echo esc_attr($_POST['start_time']);?>" class="form-control timepicker validate[required]" name="start_time"/>
					 </div>
				</div>
				<div class="form-group">
