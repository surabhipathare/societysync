		...
		<div class="panel-body"><!--PANEL BODY-->
			...
			<form name="facility_booking_form" action="" method="post" class="form-horizontal" id="facility_booking_form">
				...
				<div class="form-group"><!---BOOKING FACILITY---->
					<label class="col-sm-2 control-label"  for="member"><?php esc_html_e('Booking Facility On Behalf Of','apartment_mgt');?><span class="require-field">*</span></label>
					<div class="col-sm-8">
						<select class="form-control validate[required]" id="member_id" name="on_behalf_of">
