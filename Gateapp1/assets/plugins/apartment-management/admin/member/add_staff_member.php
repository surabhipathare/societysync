...
?>
	<script type="text/javascript">
		$(document).ready(function() {
			...
			"use strict";
			$('#staffmember_form').validationEngine({promptPosition : "bottomRight",maxErrorsPerField: 1});
		...
		<div class="panel-body"><!-------PANEL-BODY-------->
            ...
            <form name="staffmember_form" action="" method="post" class="form-horizontal" id="staffmember_form">
				...
				<div class="form-group"><!--FORM GROUP-->
					...
					<div class="col-sm-8">
						<select class="form-control validate[required] staff_category" name="staff_category">
							...
							$activity_category=amgt_get_all_category('staff_category');
					...
					<div class="col-sm-8">
						<input id="text" class="form-control text-input onlynumber_and_plussign" type="number" onKeyPress="if(this.value.length==10) return false;"  name="badge_id" 
						value="<?php if($edit){ echo $result->badge_id;}elseif(isset($_POST['badge_id'])) echo $_POST['badge_id'];?>">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input id="qualification" class="form-control validate[custom[onlyLetter_specialcharacter]]" maxlength="50" type="text"  value="<?php if($edit){ echo esc_attr($result->qualification);}elseif(isset($_POST['qualification'])) echo esc_attr($_POST['qualification']);?>" name="qualification">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label" for="Skills"><?php esc_html_e('Skills','apartment_mgt');?></label>
					<div class="col-sm-8">
						<input id="skills" class="form-control validate[custom[onlyLetter_specialcharacter]]" maxlength="50" type="text"  value="<?php if($edit){ echo esc_attr($result->skills);}elseif(isset($_POST['skills'])) echo esc_attr($_POST['skills']);?>" name="skills">
					</div>
				</div>
