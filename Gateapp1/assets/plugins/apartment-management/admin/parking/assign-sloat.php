		...
		<div class="panel-body"><!------PANEL BODY------->	
			...
			<form name="sloat_form" action="" method="post" class="form-horizontal" id="sloat_form">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<select class="form-control validate[required] unit_name" name="unit_name" id="">
...
<div class="modal fade overflow_scroll" id="myModal_add_member" role="dialog"><!---MYMODAL_ADD_MEMBER--->
