     ...
     <?php 
		...
		<div class="panel-body"><!--PANEL BODY-->
            ...
            <form name="complaint_form" action="" method="post" class="form-horizontal" id="complaint_form">
				...
				<div class="form-group">
					...
					<?php $complaintval = "complaint"; if($edit){ $complaintval=$result->complaint_nature; }elseif(isset($_POST['complaint_nature'])) {$complaintval=$_POST['complaint_nature'];}?>
						<label class="radio-inline">
						 <input type="radio" value="complaint" class="tog validate[required] complaint_nature123" name="complaint_nature"  <?php  checked( 'complaint', $complaintval);  ?>/><?php esc_html_e('Complain','apartment_mgt');?>
						</label>
						<label class="radio-inline">
						  <input type="radio" value="suggestion" class="tog validate[required] complaint_nature123" name="complaint_nature"  <?php  checked( 'suggestion', $complaintval);  ?>/><?php esc_html_e('Suggestion','apartment_mgt');?> 
						</label>
						 <label class="radio-inline">
						  <input type="radio" value="request" class="tog validate[required] complaint_nature123" name="complaint_nature"  <?php  checked( 'request', $complaintval);  ?>/><?php esc_html_e('Request','apartment_mgt');?> 
						</label>
						
						<label class="radio-inline">
						  <input type="radio" value="Maintenance Request" class="tog validate[required] complaint_nature123" name="complaint_nature"  <?php  checked( 'Maintenance Request', $complaintval);  ?>/><?php esc_html_e('Maintenance Request','apartment_mgt');?> 
						</label>
					</div>
				</div>
				<!--TITLE-->
				...
				<label class="col-sm-2 control-label" for="day"><?php esc_html_e('Member','apartment_mgt');?><span class="require-field">*</span></label>	
				<div class="col-sm-8">
			...
			<div class="category_div" style="<?php echo $category_div;?>" >
					<div class="form-group"><!--CATEGORY-->
							<label class="col-sm-2 control-label" for="activity_category"><?php esc_html_e('Category','apartment_mgt');?></label>
							<div class="col-sm-8">
								<select class="form-control  complaint_category" name="category">
							...
							<div class="col-sm-2"><button id="addremove" model="complaint_category"><?php esc_html_e('Add Or Remove','apartment_mgt');?></button></div>
						</div>
