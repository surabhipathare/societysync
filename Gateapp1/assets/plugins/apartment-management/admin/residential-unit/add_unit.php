			...
			<form name="unit_form" action="" method="post" class="form-horizontal" id="unit_form_admin_side"><!---UNIT FORM---->
				...
				<div class="form-group">
					...
					?>	
						...
						<div class="col-sm-2">
							<button id="addremove" model="building_category"><?php esc_html_e('Add Or Remove','apartment_mgt');?></button>
						</div>				
					<?php
					}
					?>
				...
				if(!empty($all_entry))
					...
					foreach($all_entry as $entry)
					{
						...
						<div id="unit_name_entry">
							...
							<div class="col-sm-2">
								<input  class="form-control validate[required,custom[phone_number]] text-input" type="number" value="<?php if(array_key_exists("measurement",$entry_array)){  echo esc_attr($entry->measurement); }?>" onKeyPress="if(this.value.length==6) return false;"  min="0" name="unit_size[]" placeholder="<?php esc_html_e('Unit Size','apartment_mgt');?>">
							</div>
					...
					<div id="unit_name_entry"><!---UNIT NAME ENTRY---->
						<div class="form-group">
							...
							<label class="col-sm-2 control-label margin_top_10_res" for="unit_entry"><?php esc_html_e('Unit Size','apartment_mgt');?>(<?php if($unit_measerment_type =='square_meter'){
								...
								?>)<span class="require-field">*</span></label>
							<div class="col-sm-2">
								<input  class="form-control validate[required] text-input" type="number" value="" min="0" name="unit_size[]" onKeyPress="if(this.value.length==6) return false;" placeholder="<?php esc_html_e('Unit Size','apartment_mgt');?>" >
							</div>
							<div class="col-sm-2">
