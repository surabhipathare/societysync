		...
		<div class="panel-body"><!--PANEL BODY-->
			...
			<form name="assets_form" action="" method="post" class="form-horizontal" id="assets_form">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input id="vender_name" maxlength="50" class="form-control text-input validate[custom[onlyLetterSp]]" type="text"  value="<?php if($edit){ echo esc_attr($result->vender_name);}elseif(isset($_POST['vender_name'])) echo esc_attr($_POST['vender_name']);?>" name="vender_name">
						</div>
					</div> 
					<div class="form-group">
					    <!------ASSET CATEGORY----->
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="asset_cost">
						<?php esc_html_e('Asset Cost','apartment_mgt'); echo ' '. '('. amgt_get_currency_symbol(get_option( 'apartment_currency_code')).')';?> </label>
						</label>
						<div class="col-sm-8">
