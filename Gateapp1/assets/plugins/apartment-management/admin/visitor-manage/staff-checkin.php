	...
	if(isset($_REQUEST['staff_checkin_id']))
		...
		<div class="panel-body"><!--PANEL BODY-->
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" value="<?php if($edit){ echo $result->checkin_time;}elseif(isset($_POST['checkintime'])) echo esc_attr($_POST['checkintime']);?>" class="form-control timepicker validate[required]" name="checkintime"/>
				 </div>
			</div>
